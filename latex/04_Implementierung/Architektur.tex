...
Die Funktion einer Regel ist im Prinzip immer ähnlich: Zuerst muss geprüft werden, ob eine Regel zur Anwendung kommen kann. Dies geschieht mit der Methode $isApplicable$. Wenn diese Methode $wahr$ zurückgeliefert, kann die Regel  mit Hilfe von $apply$ angewendet werden. Das Ergebnis ist ein neuer Planknoten.
