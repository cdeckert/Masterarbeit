...
\subsubsubsection{Ablauf / Reihenfolge der Planoptimierung}
...
\subsubsubsection{Wiederverwendung von Äquivalenzknoten}
...
\subsubsubsection{Seperation von Enforcer und Algrothm Plan Spaces}
...
\subsubsubsection{Unvollständigkeit von RS-02}
...
\subsubsubsection{Vorschlag von RS-Graph}
...
\subsubsection{Patition zu Graph}
...
\subsubsubsection{Probleme auf Grund der Plattformwahl}
