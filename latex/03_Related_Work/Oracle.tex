...
\subsubsubsection{State Space Search Techniques}
...
\subsubsubsection{Subquery Entschachtelung}

\subsubsubsection{Join Elimination}

\subsubsubsection{Filter Predicate Move Around}

\subsubsubsection{Group Pruning}
