...
public:
	...
	BitVectorSmall(const char *x) : _bitvector(0)
	{
		this->initFromCstring(x);
	}
	~BitVectorSmall() {}
public:
	inline bitvector_t bitvector() const
	{
		return _bitvector;
	}
	inline bitvector_t content() const
	{
		return _bitvector;
	}
public:
	...
	{
		return (((bitvector_t) 0) == _bitvector);
	}
...
public:
	inline BitVectorSmall &reset()
	{
		_bitvector = 0;
		return (*this);
	}
	inline BitVectorSmall &clear()
	{
		_bitvector = 0;
		return (*this);
	}
	inline BitVectorSmall &operator++()
	{
		++_bitvector;
		return (*this);
	}
...
public:
	...
	inline bool
	test(element_t i) const
	{
		return (((((bitvector_t) 1) << i) & _bitvector) != 0);
	}

	inline BitVectorSmall &
	set(element_t i)
	{
		_bitvector |= (((bitvector_t) 1) << i);
		return (*this);
	}

	inline BitVectorSmall &
	set_only(element_t i)
	{
		_bitvector = (((bitvector_t) 1) << i);
		return (*this);
	}
	...
	inline BitVectorSmall &
	set_first_n(element_t i)
	{
		_bitvector = ((((bitvector_t) 1) << i) - 1);
		return (*this);
	}
	...
	inline BitVectorSmall &
	operator=(const BitVectorSmall &x)
	{
	...
	inline BitVectorSmall &
	union_with(const BitVectorSmall &x)
	{
		_bitvector |= x._bitvector;
		return (*this);
	}
	...
	inline BitVectorSmall &
	intersect_with(const BitVectorSmall &x)
	{
		_bitvector &= x._bitvector;
		return *this;
	}
	...
	inline BitVectorSmall &
	set_difference(const BitVectorSmall &x)
	{
		_bitvector &= (~(x._bitvector));
		return *this;
	}
	...
	inline BitVectorSmall &
	complement(const BitVectorSmall &x)
	{
		_bitvector = (~x._bitvector);
		return *this;
	}

	inline bitvector_t lowest_bit() const
	{
		return lowest_bit(_bitvector);
	}
	static inline bitvector_t lowest_bit(bitvector_t x)
	{
		return (x & (-x));
	}
	inline element_t   lowest_bit_index() const
	{
		return lowest_bit_index(_bitvector);
	}
	...
	inline element_t log2() const
	{
		return log2(_bitvector);
	}
	static element_t log2(register bitvector_t x);

	inline element_t highest_bit() const
	{
		return highest_bit(_bitvector);
	}
	static element_t highest_bit(register bitvector_t x);
	inline element_t highest_bit_index() const
	{
		return log2(highest_bit());
	}

public:
	// arighmetics
	inline BitVectorSmall &add(const bitvector_t x)
	{
		_bitvector += x;
		return (*this);
	}
public:
	inline bool operator==(const BitVectorSmall &x) const
	{
...
public:
	inline bool overlap(const BitVectorSmall &x) const
	{
		return (0 != (_bitvector & x._bitvector));
	}
	inline bool intersects_with(const BitVectorSmall &x) const
	{
		return (0 != (_bitvector & x._bitvector));
	}
	inline bool intersects(const BitVectorSmall &x) const
	{
		return (0 != (_bitvector & x._bitvector));
	}
	inline bool disjoint(const BitVectorSmall &x) const
	{
		return (0 == (_bitvector & x._bitvector));
	}
	inline bool disjoint_with(const BitVectorSmall &x) const
	{
		return (0 == (_bitvector & x._bitvector));
	}
	inline bool contains(const BitVectorSmall &x) const
	{
		return (_bitvector == (_bitvector | x._bitvector));
	}
	inline bool notContains(const BitVectorSmall &x) const
	{
		return (_bitvector != (_bitvector | x._bitvector));
	}
public:
...
public:
	...
	IteratorElement begin() const
	{
		return IteratorElement(_bitvector);
	}
	IteratorElement end()   const
	{
...
public:
	...
	inline IteratorBit beginBit() const
	{
		return IteratorBit(_bitvector);
	}
	inline IteratorBit endBit()   const
	{
		return IteratorBit();
	}
...
public:
	...
	public:
		...
		{
			return BitVectorSmall(_current);
		}
		bitvector_t get() const
		{
			return _current;
		}
		bitvector_t getFullSet() const
		{
			return _bitvector;
		}
		...
		inline bool isValid() const
		{
			return (_bitvector != _current);
		}
	private:
		bitvector_t _bitvector; // const
		bitvector_t _current;
	};
	IteratorSubset beginSub() const
	{
		return IteratorSubset(_bitvector);
	}
	IteratorSubset endSub()   const
	{
		return IteratorSubset(_bitvector, _bitvector);
	}
...
#define SUPERMASK(i)  ((1 << (i)) - 1)
	...
	public:
		BitVectorSmall operator*()
		{
			if ((uint_t) _bitvector ==  (uint_t) (~_current))
			{
				return BitVectorSmall(_mask);
			}
			else
			{
				return BitVectorSmall(~_current & _mask);
			}
		}
	...
	IteratorSuperset beginSuper() const
	{
		return IteratorSuperset(_bitvector, ~(uint_t)0);
	}
	IteratorSuperset endSuper()   const
	{
		return IteratorSuperset();
	}
#undef SUPERCAP
#undef SUPERMASK
public:
